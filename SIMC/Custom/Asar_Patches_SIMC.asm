; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SIMC_InsertIntegratedPatches and SIMC_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SIMC_InsertIntegratedPatches()
...
macro SIMC_ApplyPatchesPostAssembly()
